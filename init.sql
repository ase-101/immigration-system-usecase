...
INSERT INTO esignet.client_detail(id,name,rp_id,logo_uri,redirect_uris,claims,acr_values,public_key,public_key_hash,enc_public_key,enc_public_key_hash,grant_types,auth_methods,status,additional_config,cr_dtimes,upd_dtimes) VALUES
	 ('mosip-signup-oauth-client','{"@none":"Bureau of Immigration, Veridonia"}','mock-relying-party-id','http://localhost:4000/images/veridonia_emblem.svg','["http:\/\/localhost:4000\/**","http:\/\/localhost:3000\/registration\/*"]','["name","email","gender","phone_number","picture","birthdate"]','["mosip:idp:acr:generated-code","mosip:idp:acr:password","mosip:idp:acr:linked-wallet","mosip:idp:acr:id-token"]','{"kty":"RSA","use":"sig","alg":"RS256","n":"q9zKITacEDQhbwn55t_WiqYuWf5T6AMOUo3Ze_DDu8jTvcJs42PFia8n6bLQ_5yLCnR2IhCSpezvUwYmUBQQYmaJUn1X3GgwmP8ZRo2eEc1DhWiiL0Xtfh3Xh50FsAEaMqRxXEEyEEb49SbxCgYSMnSsyPMb3iOB578LDYt4G_rzhH1cKekIUdEdK-LDyQkiAhe81BT2aWbj0bmm-cPd5n1Hf9WlDpNtbDoh8PcFYGlV39JxuX5iY6LrnAe9Ho_h2ZvLb7BydccfB3EZX71wVqPW3go4PRtHi7SUN1ovB7l1lh41mpr00BaQQ2lYOB6poLuHJWN30dve00Apofk8jQ","e":"AQAB"}','a13c8ab3837d49eddb4e329754be0894e7b14a87ad7100195eb47bf674983e58',NULL,NULL,'["authorization_code"]','["private_key_jwt"]','ACTIVE','{"userinfo_response_type":"JWS","purpose":{"type":"verify"},"signup_banner_required":true,"forgot_pwd_link_required":true,"consent_expire_in_mins":20}','2026-02-06 07:45:43.829865',NULL),
	 ('IIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA7ADUw','{"@none":"Omera Bank, Veridonia"}','mock-relying-party-id','http://localhost:5001/favicon.ico','["http:\/\/localhost:5001\/**"]','["name","email","picture"]','["mosip:idp:acr:generated-code"]','{"kty":"RSA","kid":"yJTL4mgzrfqR4acjJB3eu06xveu60Fv8lFvDt4iHSr0","use":"sig","alg":"RS256","n":"7ADUwoOQmXIvqxligKjVu-N7Ii728uo-ZEMii7qghaOT5seemLrn4W09ATER3nlyk4KoBHiXBtIYBICMUbZu5qr9TcH9PgWJxuSlpmu5Gakl6KlW7TKaaukQDCf3GMNXgtIj15DQBkLx-lyBDbipclLf4DsK3H8l_odYRDES7Hmek8CG2hqwuI5yakQRTIzkFDQAp9_kYCOgI7ZDvcrKp4xHpBwQYT9ie78O-6CFNlk9PMxmqZRegkGychelIaG8f0oLmyxpxZHFZdRajwyMmNmII0hWte4y0nl0C22JA1dsi-52o2k5eONdoTboylwc54P0abjITOrkqliLfzl63Q","e":"AQAB"}','1e54d96d7c355de08520979da1b5f88885e08083e063ef2968f71ff452224607',NULL,NULL,'["authorization_code"]','["private_key_jwt"]','ACTIVE','{"userinfo_response_type":"JWS","purpose":{"type":"login"},"signup_banner_required":true,"forgot_pwd_link_required":true,"consent_expire_in_mins":20}','2026-02-06 07:47:58.844832',NULL),
     ('IIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKC','{"@none":"Health Portal, Veridonia"}','mock-relying-party-id','http://localhost:5002/favicon.ico','["http:\/\/localhost:5002\/**"]','["name","email","picture"]','["mosip:idp:acr:generated-code"]','{"kty":"RSA","use":"sig","alg":"RS256","n":"wvdIV6er_jLkC9gEq9NHs8hFBt4Nuk4agTjdlKMspp6snQiI14fGPz7CSqkPZn_rDphKiB1sQbfmTyAdGM3JJynw3mCrgtpfo7R0G31UBOlwXGX0YcBzpuJQZ4HrlEUaKasDAZYOM5O6MH0DL_l3hm1h9yVuYQYnSp5LOOFe_YgMjz-q9DwAlDa4vI7A5ZS9wC3AUzvq_lybYiQPr1syw-zlrHxkEZytBfh5s4O-px5opxVo0EKfQjR20XhxwhQEUkrCSGlNUz02dszRiSTynql9uANaO_e9-ekPXMMKSmvzX2jNXzyjtF3FCWtY2wj1sM-TAfmTT3wn9JskLSTQFw","e":"AQAB"}','dummy-hash',NULL,NULL,'["authorization_code"]','["private_key_jwt"]','ACTIVE','{"userinfo_response_type":"JWS","purpose":{"type":"login"},"signup_banner_required":false,"forgot_pwd_link_required":false,"consent_expire_in_mins":20}','2026-02-06 07:47:58.844832',NULL);
